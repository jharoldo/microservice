...
class CustomerController:
    ...
    def get_customer(self, customer_internal_id: int, login: str, include_inactive: bool = False) -> dict:
    ...
    def create_customer(self, customer_data: dict, login: str) -> dict:
    ...
    def update_customer(self, customer_data: dict, login: str) -> dict:
    ...
    def list_customers(self, login: str, include_inactive: bool = False) -> dict:
    ...
    def delete_customer(self, customer_internal_id: int, login: str) -> dict:
