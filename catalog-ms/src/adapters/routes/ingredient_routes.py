...
def create_ingredient(
    ...
    return controller.create_ingredient(ingredient.dict(), login)
...
def list_ingredients(
    ...
    return controller.list_ingredients(login, include_inactive=include_inactive)
...
def list_ingredients_by_type(
    ...
    return controller.list_ingredients_by_type(type, login, include_inactive=include_inactive)
...
def get_ingredient(
    ...
    return controller.get_ingredient(ingredient_id, login, include_inactive=include_inactive)
...
def update_ingredient(
    ...
    return controller.update_ingredient(ingredient.dict(), login)
...
def delete_ingredient(
    ...
    return controller.delete_ingredient(ingredient_id, login)
...
def list_ingredient_types(
    ...
    return controller.list_ingredient_types(login)